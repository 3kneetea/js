...
create() {
    ...
    this.add.text(0,560, 'Level 1', { font: '24px Courier', fill: '#FFFFFF' }).setScrollFactor(0);
...
update() {
    ...
    this.bg_b.tilePositionX = this.cameras.main.scrollX * .1;
    this.bg_f.tilePositionX = this.cameras.main.scrollX * .8;
