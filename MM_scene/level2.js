...
create() {
    ...
    this.add.text(0,560, 'Level 2', { font: '24px Courier', fill: '#FFFFFF' }).setScrollFactor(0);
...
this.mummies.create(300, 600, 'mummy').setScale(1);
...
this.mummies2.create(500, 600, 'mummy2').setScale(1);
this.mummies2.create(700, 600, 'mummy2').setScale(1);
this.mummies2.create(1400, 600, 'mummy2').setScale(1);
this.mummies2.create(1800, 600, 'mummy2').setScale(1);
this.mummies2.create(2100, 600, 'mummy2').setScale(1);
...
this.physics.add.collider(this.groundLayer, this.mummies2);
